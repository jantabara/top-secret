...
const Index = () => {
  return (
    <Layout>
          ...
          <div className="row">
            <div className="col-lg-12 p-0">
              <div className="hero-content wow fadeInLeft delay-0-2s">
                <h1 id="hero-text">
                  <div className="hero-content-first fade-hero">Digitální</div>
                  <div className="hero-content-second fade-hero">vývojové</div>
                  <div className="hero-content-third fade-hero">studio</div>
                </h1>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-between">
            <div className="col-xl-5 col-lg-3">
              <div className="about-image rmb-45 wow fadeInUp delay-0-2s">
                <h1 className="about-image-container hero-title mb-100 rmb-50 wow fadeInUp delay-0-2s">
      ...
      <div className="statistics-area pt-75 rpt-45 rel z-1 my-60">
        <div className="container">
          <div className="row justify-content-between">
            ...
            <div className="col-lg-3 col-6">
              <div className="counter-item counter-text-wrap wow fadeInUp delay-0-5s">
                ...
                <span className="counter-title">Spokojenost</span>
              </div>
            </div>
            <div className="col-lg-3 col-6">
              <div className="counter-item counter-text-wrap wow fadeInUp delay-0-4s">
                <Counter end={3} />
                <span className="counter-title">Profesionálové</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* <div className="headline-area pt-90 rpt-85 rel z-1">
        <div className="container-fluid">
          <div className="headline-text marquee">
            <span>
              web development <span>app development</span> Konzultace
            </span>
          </div>
        </div>
      </div> */}
      ...
      {/* What We Do end */}
      {/* Skills Area Start */}
      <section className="skills-area pt-100 rpt-70 rel z-1 my-80">
        <div className="container container-1590">
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section-title text-center mb-80 wow fadeInUp delay-0-2s">
                <span className="sub-title mb-20">Technologie</span>
                <h2>Používáme tyto technologie</h2>
              </div>
            </div>
          </div>
